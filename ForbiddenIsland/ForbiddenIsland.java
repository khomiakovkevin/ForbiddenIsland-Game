...
// to represent FindCell
class FindCell implements IPred<Cell> {

    // to compare x and y of a Cell
...
// to represent FindTarget
class FindTarget implements IPred<Target> {
    
    // to compare x and y of a Target
...
class Utils {
    ...
    ArrayList<ArrayList<Double>> initial() {
        ...
        newlist.get(ForbiddenIslandWorld.ISLAND_SIZE)
            .set(ForbiddenIslandWorld.ISLAND_SIZE / 2, (double) 1);
        newlist.get(ForbiddenIslandWorld.ISLAND_SIZE / 2)
            .set(0, (double) 1);
        newlist.get(ForbiddenIslandWorld.ISLAND_SIZE / 2)
            .set(ForbiddenIslandWorld.ISLAND_SIZE, (double) 1);
        newlist.get(ForbiddenIslandWorld.ISLAND_SIZE / 2)
            .set(ForbiddenIslandWorld.ISLAND_SIZE / 2, (double) 30);
...
class ForbiddenIslandWorld extends World {
    ...
    public WorldScene lastScene(String s) {
        ...
        in.placeImageXY(new TextImage(s, 30, FontStyle.BOLD, Color.BLUE),
    ...
    public WorldEnd worldEnds() {
        ...
        if (this.player.piecesgot >= 3 && this.player.x == ISLAND_SIZE / 2 + 1 &&
            ...
            return  new WorldEnd(true, this.lastScene("Congratulations!"));
        }
        else if (this.board.find(f, this.player.x, this.player.y).isFlooded) {
            return new WorldEnd(true, this.lastScene("whoops"));
        }
        else {
    ...
    // to represent what is rendering on each tick
    // here is only water
    public void onTick() {
        if (this.tickcount == 9) {
